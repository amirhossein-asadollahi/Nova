...
const OrderSummary = ({ totalPrice, deliveryTax, discountCode = null }) => {
  return (
    <>
      ...
      <div className="flex flex-col space-y-8 mt-2">
        ...
        <div className="">
          <button className="bg-primary text-white hover:bg-primary-dark w-full px-4 py-2 flex items-center justify-center rounded-lg cursor-pointer">
